function stworzGui()
	...
	guiGridListAddColumn(lista,"Cena w GP",0.3)
...
stworzGui()
function sklep_gp_pokaz(dane)
	guiSetText(gui,"Sklep, posiadasz: "..getPlayerMoney().."gp")
...
addEvent("sklep_gp_pokaz",true)
addEventHandler("sklep_gp_pokaz",getRootElement(),sklep_gp_pokaz)
function click()
