...
addEvent ( "specatator_log", true )
addEventHandler ( "specatator_log", _root, function (gracz)
	outputServerLog("SPECTATE: "..getPlayerName(gracz).." UID:"..tostring(getElementData(gracz,"UID")).." przez: "..getPlayerName(client).." UID:"..tostring(getElementData(client,"UID")))
end )
...
function checkNickOnChange(old, new)
	if isPlayerMuted(source) then
		cancelEvent()
		return outputChatBox("Nie możesz zmieniać nicku!",source,255,0,0)
	end
